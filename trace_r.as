package
{
	...
	public function trace_r(obj:*=null, omitProps:Array=null, tabCount:int=0, runTrace:Boolean=true, refArray:Array=null):String
	{
		...
		if (refArray == null) refArray = []; 	// ensures that if there is a duplicate reference it doesn't continue to recursively call on that. preventing endless loops,
